...
void solve() {
    ...
    ll mx = max({a1, b1, a2,b2,a3,b3});
    pl p1 = {-1,-1}, p2 = {-1,-1}, p3 = {-1,-1}, p4 = {-1,-1}, p5 = {-1,-1}, p6 = {-1,-1};
    vpl ans;
    if(a2==a3) {
        pl p1 = {a2, b2+b3};
        if(a1==p1.f) ans.pb({a1, b1+p1.s});
        if(b1==p1.s) ans.pb({a1+p1.f, b1});
    }
    if(b2==b3) {
        pl p2 = {a2+a3, b2};
        if(a1==p2.f) ans.pb({a1, b1+p2.s});
        if(b1==p2.s) ans.pb({a1+p2.f, b1});
    }
